...
const properties: INodeProperties[] = [
	modelRLC('audioModelSearch'),
	{
		...
		name: 'text',
		type: 'string',
		placeholder: 'e.g. Summarize this audio',
		default: 'Summarize this audio',
		typeOptions: {
			rows: 2,
		},
	},
	...
	},
	{
		...
		description: 'URL(s) of the audio file(s) to analyze, separate multiple with commas',
		default: '',
		displayOptions: {
			show: {
				inputType: ['url'],
	...
	},
	{
		...
		description: 'Name of the binary field(s) containing the audio, separate multiple with commas',
		displayOptions: {
			show: {
				inputType: ['binary'],
			},
